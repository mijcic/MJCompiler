...
public class Factor_designator_fun_params extends Factor {

    private DesignatorOption DesignatorOption;
    private ActParsList ActParsList;

    public Factor_designator_fun_params (DesignatorOption DesignatorOption, ActParsList ActParsList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("Factor_designator_fun_params(\n");
