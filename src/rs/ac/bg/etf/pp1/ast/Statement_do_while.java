...
public class Statement_do_while extends Statement {
    ...
    public Statement_do_while (StartOfDoWhileLoop StartOfDoWhileLoop, Statement Statement, StartOfCondition StartOfCondition, EndOfDoWhileLoop EndOfDoWhileLoop) {
