...
public class Statement_do_while_condition_comma_statement extends Statement {
    ...
    public Statement_do_while_condition_comma_statement (StartOfDoWhileLoop StartOfDoWhileLoop, Statement Statement, StartOfCondition StartOfCondition, ConditionList ConditionList, DesignatorStatement DesignatorStatement, EndOfDoWhileLoop EndOfDoWhileLoop) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("Statement_do_while_condition_comma_statement(\n");
